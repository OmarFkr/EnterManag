...
class generate extends Command
{
    ...
    public function createModel($data){
      ...
      // Create the file
      $modelTemplate = view::make('templates.model',['data' => $data])->render();
      $modelTemplate = "<?php \n".$modelTemplate." ?>";
    ...
    public function createController($data){
      ...
      // Create the file
      $controllerTemplate = view::make('templates.controller',['data' => $data])->render();
    ...
    public function createVueListTemplate($data){
      ...
      // Create the file
      $vueTemplate = view::make('templates.vue-list',['data' => $data])->render();
    ...
    public function createVueSingleTemplate($data){
      ...
      // Create the file
      $vueTemplate = view::make('templates.vue-single',['data' =>$data])->render();
